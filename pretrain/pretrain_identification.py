...
import os
os.chdir("/share/project/tanghan/sharefs-hantang/tanghan/Chemical_Reaction_Pretraining/pretrain/")
sys.path.insert(0,'..')
...
@hydra.main(version_base=None, config_path="/share/project/tanghan/sharefs-hantang/tanghan/Chemical_Reaction_Pretraining/conf", config_name="config")
def main(cfg):
    ...
    if not cfg.model.output_model_file == "" and not cfg.training_settings.testing_stage:
           torch.save(model.state_dict(), cfg.model.output_model_file + "_{}_reaction_centre_identification.pth".format(cfg.model.target))
