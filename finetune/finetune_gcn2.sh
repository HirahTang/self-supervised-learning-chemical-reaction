...
export model_file=/share/project/tanghan/sharefs-hantang/tanghan/Chemical_Reaction_Pretraining/pretrain/stage2_NodeEdge_no_stop_gradient_work_two_hop.pth
export model_type=NodeEdge_5_epoch
export mask_type=TwoHop
