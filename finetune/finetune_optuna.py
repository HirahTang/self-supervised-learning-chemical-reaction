...
import sys
import os
os.chdir("/share/project/tanghan/sharefs-hantang/tanghan/Chemical_Reaction_Pretraining/finetune/")
sys.path.insert(0,'..')
...
def objective(trial):
    ...
    val_loader = DataLoader(valid_dataset, batch_size=batch_size, shuffle=False, num_workers = args.num_workers)
    ...
    model, graph_pooling = define_model(trial)
