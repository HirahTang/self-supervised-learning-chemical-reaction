...
export model_file=/share/project/tanghan/sharefs-hantang/tanghan/Chemical_Reaction_Pretraining/pretrain/stage2_mlabe_no_stop_gradient_2two_hop.pth
export model_type=Mlabes
export mask_type=2hop
